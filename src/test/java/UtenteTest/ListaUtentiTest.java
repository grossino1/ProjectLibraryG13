...
public class ListaUtentiTest {
    ...
    void setUp()throws Exception{
        ...
        u3 = new Utente(NOME_VALIDO_U3, COGNOME_VALIDO_U3, MATRICOLA_VALIDA_U3, EMAIL_VALIDA_U3);
    }
    ...
    void testCercaUtenteValida() throws Exception{
        ...
        assertEquals(2, risultatiCognome.size(), "Dovrebbe trovare due utenti");
